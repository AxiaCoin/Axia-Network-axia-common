...
//! AXIA Codec serialization support for uint and fixed hash.
...
/// Add AXIA Codec serialization support to an integer created by `construct_uint!`.
#[macro_export]
...
/// Add AXIA Codec serialization support to a fixed-sized hash type created by `construct_fixed_hash!`.
#[macro_export]
